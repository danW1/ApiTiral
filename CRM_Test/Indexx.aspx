<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Indexx.aspx.cs" Inherits="CRM_Test.Index" %>
...
<body>
    <!--Header-part-->
    <div id="header">
      <h1><a href="dashboard.html">教员管理系统</a></h1>
    </div>
    <!--close-Header-part--> 
    ...
    <div id="sidebar" style="OVERFLOW-Y: auto; OVERFLOW-X:hidden;">
        <ul>
            <li class="submenu"> 
                ...
                <ul>
                    <li><a class="menu_a" link="SchoolStudentS.aspx"><i class="icon icon-caret-right"></i>导入校区学生信息</a></li>
                </ul>
            </li>
               <li class="submenu"> 
                <a href="#">
                ...
                <ul>
                    <li><a class="menu_a" link="TrainClassStudent.aspx"><i class="icon icon-caret-right"></i>分班管理</a></li>
                     <li><a class="menu_a" link="StudentInfoExce.aspx"><i class="icon icon-caret-right"></i>导出学生信息</a></li>
                </ul>
            </li>
        </ul>
    </div>
